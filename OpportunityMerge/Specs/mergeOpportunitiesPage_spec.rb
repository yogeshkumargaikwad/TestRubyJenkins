...
describe MergeOpportunities do
    ...
    puts "number of opp selected on 1st page"
    ...
    puts @driver.current_url()
		...
		expect(afterMergeSecondary[0].fetch("Merged_Opprtunity__c")).to eq opportunityData["1"]["0"][1]

		puts "Checking Secondary opportunity Stage"
		expect(afterMergeSecondary[0].fetch("StageName")).to eq "Merged"
